//! Whisper model catalog, download, settings persistence, and path resolution.

use crate::state::{
    AppConfig, DeviceProfile, DictationModelOption, LocalModelState, LocalSettings,
    WhisperModelSpec, WHISPER_MODEL_CATALOG, APP_MODELS_DIR, APP_SETTINGS_DIR, APP_SETTINGS_FILE,
};
use std::fs;
use std::io::Write;
